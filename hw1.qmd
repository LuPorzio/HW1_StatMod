...
```{r, echo=FALSE, fig.width=8, fig.height=6, fig.cap="Distribution of Continuos Variables split by CHD"}
...
plot(ks,err_train, col="#D81B60", type = "l", lwd=3, ylim = c(0, .30), 
     ylab = "Error Rate", xlab = "1/k")
lines(ks,err_test, col="#1E88E5", type = "l", lwd=3)
